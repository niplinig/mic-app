import { Note, Button, Display, Keyboard, useTabs, KeyCode, useKeyboard, useToasts } from "@geist-ui/core";
    ...
    return (
        <div>
            ...
            <Display shadow caption={
                ...
                <video preload="auto" className="max-w-screen-md" id="Exceso de velocidad" ref={video} onPlay={detectVideoStarts} onEnded={detectVideoEnds}>
                    <source src='/exp/mp4/ExcesoDeVelocidad.mp4' type="video/mp4" />
                    <source src='/exp/webm/ExcesoDeVelocidad.webm' type="video/webm" />
                </video>
            </Display>
        </div>
    );
